...
`,_=`# Prompt caching, Claude'un en ucuz optimizasyonu. Kimse ölçmüyor.
...
`,B=`# Claude agent'larını trace replay ile debug ediyorum
...
`,D=`# İki hafta sonunda dört açık kaynak Claude dev-tool shiplerken neler öğrendim
...
`,C=`# See the prompt before you ship it
...
`,R=`# Nobody's model failed. The interface did.
...
`,L=`# The deliverable isn't the prompt. It's the eval.
