...
`,k=`# Cursor IDE and Prompt Engineering
...
`,p=`# Neden Bazen Sadece Boş Ekrana Bakıyorum
...
`,B=`# Prompt'un daha iyi değil. Sadece daha iyi hatırlıyorsun.
...
`,L=`# Nobody's model failed. The interface did.
...
`,K=`# I accidentally built a forward-deployed engineer's field kit
...
Part three: [The deliverable isn't the prompt. It's the eval.](https://ferhatatagun.com/blog/the-eval-is-the-deliverable) ·
Part four: [You're not done when it works. You're done when they can change it.](https://ferhatatagun.com/blog/done-when-they-can-change-it)*
`,Z=`# Your context window bills you every turn
...
`,X=`# Bağlam biriktirilmez, her turda yeniden faturalanır
...
`,Q=`# Two AI vulnerabilities that never throw an exception
...
`,ee=`# Hiç exception fırlatmayan iki yapay zeka açığı
