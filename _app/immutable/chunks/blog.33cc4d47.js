...
`,A=`# Prompt'un daha iyi değil. Sadece daha iyi hatırlıyorsun.
...
`,I=`# Tek bir tool yazmadan önce sandbox'ı kur
...
`,O=`# See the prompt before you ship it
...
`,D=`# Prompt'u shiplemeden önce gör
